...
#~     pcr.aguila(catchment_map_size) 
    ...
    # ~ upstream_threshold_cells         = pcr.cover(upstream_threshold_cells, pcr.ifthen(catchmenttotal_large_catchments == threshold * 30., pcr.boolean(1.0)))
    # ~ upstream_threshold_cells         = pcr.cover(upstream_threshold_cells, pcr.ifthen(catchmenttotal_large_catchments == threshold * 40., pcr.boolean(1.0)))
